...
$PORTAL_userlevel=5; // Minimum required ViciDial user level to enable dynamic portal authentication
...
$PORTAL_redirectadmin='https://server.ip/vicidial/admin.php'; // Only matters if the above is not X and the valued of the $PORTAL_adminfield in vicidial_users equals 'admin'
