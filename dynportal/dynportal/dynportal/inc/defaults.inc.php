...
$PORTAL_redirectadmin='https://192.168.29.105/index.html'; // Only matters if the above is not X and the valued of the $PORTAL_adminfield in vicidial_users equals 'admin'
